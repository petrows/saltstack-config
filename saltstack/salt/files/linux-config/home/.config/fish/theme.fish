...
set -U fish_color_command 99cc99 --bold
...
set -U fish_color_valid_path --underline=single --underline
...
set -U fish_pager_color_prefix normal --bold --underline=single --underline
