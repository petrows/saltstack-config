...
check_mk_agent:
  ...
  filename: check-mk-agent_2.1.0p12-1_all.deb
  checksum: b3d9bf45a7c7c3a39cd15cb451ff6199
...
git_config:
  ...
  alias.cm: "!f() { git checkout -f --recursive-submodules master; git pull --rebase }; f"
